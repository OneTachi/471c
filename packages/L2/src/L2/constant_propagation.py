...
def constant_propagation_program(program: Program) -> Program:
    return Program(parameters=program.parameters, body=constant_propagation_term(program.body, {}))
...
def constant_propagation_term(term: Term, context: Context) -> Term:
    ...
    match term:
        ...
        case Let(bindings=bindings, body=body):
            ...
            return Let(bindings=new_bindings, body=constant_propagation_term(body, inner_context))

        case Abstract(parameters=parameters, body=body):
            inner_context = {k: v for k, v in context.items() if k not in parameters}
            return Abstract(parameters=parameters, body=constant_propagation_term(body, inner_context))
        ...
        case Apply(target=target, arguments=arguments):
            ...
            return Apply(target=recur(target), arguments=new_args)
        ...
        case Begin(effects=effects, value=value):  # pragma: no branch
            ...
            return Begin(effects=new_effects, value=recur(value))
